    ...
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-10 pt-20 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto">
        ...
        <p className="text-[#667788] text-lg max-w-xl mx-auto mb-10 leading-relaxed">
          A modular ecosystem of AI-powered agents built for orchestration, automation, and real-time decision-making. Each agent specializes in a domain—RAG pipelines, web scraping, financial analysis, developer tooling, and more—while seamlessly integrating through APIs and shared context.
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#agents"
            className="group relative px-8 py-3.5  font-semibold text-black overflow-hidden text-sm"
          >
